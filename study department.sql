...
CREATE TABLE IF NOT EXISTS `study_department`.`subjects_has_groups` (
  ...
  PRIMARY KEY (`subjects_subject_id`, `groups_group_id`),
  INDEX `fk_subjects_has_groups_groups1_idx` (`groups_group_id` ASC) VISIBLE,
  INDEX `fk_subjects_has_groups_subjects1_idx` (`subjects_subject_id` ASC) VISIBLE,
